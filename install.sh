...
AddPFTable()
{
    ...
    echo "   - ${pfmessage}:"
    echo "     ${moreinfo}"
    echo "     https://documentation.wazuh.com/current/user-manual/capabilities/active-response"
...
main()
{
    ...
    if [ "X$INSTYPE" = "Xserver" ]; then
        ...
        echo ""
        echo "   ${moreinfo}"
        echo "   https://documentation.wazuh.com/current/user-manual/agents/registering-agents"
        echo ""
